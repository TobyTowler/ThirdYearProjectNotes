...
def avoidance(mower, path, target, virtual_bounds, centre_line, test_shape,
    ...
    while utm_dist([mower.x, mower.y], path[target]) > 0.2:
        m = 0
        detected_line = mower.get_detected_line(target, virtual_bounds, 0,
...
def main(args=None):
    ...
    test_shape = np.array([[380679.5577960311, 5831454.467463246],
                           [380681.5577960311, 5831454.467463246],
                           [380681.5577960311, 5831456.467463246],
                           [380679.5577960311, 5831456.467463246]])
    # add nogos at some point

    test_shape = to_utm(test_shape)
    path = np.array([[380681.25779603, 5831456.16746325],
                     [380679.85779603, 5831456.16746325],
                     [380679.85779603, 5831454.76746325],
                     [380681.25779603, 5831454.76746325],
                     [380681.25779603, 5831456.16746325],
                     [380680.68279603, 5831454.91746325],
                     [380680.68279603, 5831456.11746325],
                     [380680.45779603, 5831456.11746325],
                     [380680.45779603, 5831455.21746325],
                     [380680.23279603, 5831455.21746325],
                     [380680.23279603, 5831456.11746325],
                     [380680.00779603, 5831456.11746325],
                     [380680.00779603, 5831454.91746325],
                     [380680.23279603, 5831454.91746325],
                     [380680.45779603, 5831454.91746325],
                     [380680.45779603, 5831455.21746325],
                     [380680.90779603, 5831455.21746325],
                     [380680.90779603, 5831454.91746325],
                     [380681.13279603, 5831454.91746325],
                     [380681.13279603, 5831455.21746325],
                     [380681.13279603, 5831456.11746325],
                     [380681.13279603, 5831455.81746325],
                     [380680.90779603, 5831455.81746325],
                     [380680.90779603, 5831456.11746325],
                     [380680.90779603, 5831455.81746325],
                     [380680.90779603, 5831455.81746325],
                     [380681.13279603, 5831455.81746325],
                     [380681.13279603, 5831455.51746325],
                     [380680.00779603, 5831455.51746325],
                     [380680.00779603, 5831455.21746325],
                     [380680.23279603, 5831455.21746325],
                     [380680.23279603, 5831454.91746325],
                     [380680.00779603, 5831454.91746325],
                     [380680.23279603, 5831454.91746325],
                     ...
                     [380681.13279603, 5831455.21746325],
                     [380680.23279603, 5831455.21746325],
                     [380680.23279603, 5831455.51746325],
                     [380680.23279603, 5831455.81746325],
                     [380680.45779603, 5831455.81746325],
                     [380680.68279603, 5831455.81746325],
                     [380680.68279603, 5831456.11746325],
                     [380681.13279603, 5831456.11746325],
                     [380680.90779603, 5831456.11746325],
                     [380680.00779603, 5831456.11746325],
    ...
    while target < path_len:
        ...
        if mower.tries > mower.max_tries(path, target):
            ...
            if not access or apath == [[mower.x, mower.y]
                ...
                for a in apath[:-1]:
                    ...
                    try:
                        avoidance(mower, np.array(apath), atarget,
                                        virtual_bounds, centre_line,
                                        test_shape, acurrent, right_bear,
        ...
        # If the mower is off course
            ...
            detected_line = mower.get_detected_line(
                ...
                current, np.array([path[current], path[target], p]))
            ...
            try:
                avoidance(mower, path, target, virtual_bounds,
                                centre_line, test_shape, current,
                                right_bear, left_bear, centre_bear)
            except (NoTurns, NoPath) as e:
                current += 1
                target += 1
