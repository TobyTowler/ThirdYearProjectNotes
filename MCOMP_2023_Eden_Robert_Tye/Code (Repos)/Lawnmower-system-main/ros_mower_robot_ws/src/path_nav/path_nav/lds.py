...
class LFCDLaser:
    ...
    def __init__(self, port, baud_rate):
        ...
        self.serial = serial.Serial(port, baud_rate, timeout=10)
    ...
    def poll(self):
        ...
        """
        return []
        self.serial.write(b"b") # Shouldn't need but running and stopping the NODE often blocks the serial read
        temp_char = 0
        start_count = 0
        got_scan = False
