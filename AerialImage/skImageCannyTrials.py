...
#
#     # Plot results
#     rows = len(grouped_combinations) + 1  # Additional row for the original image
#     cols = max(len(grouped_combinations[sigma]) for sigma in grouped_combinations)
#
...
#                 grouped_combinations.get(list(grouped_combinations.keys())[row], [])
#             ):
...
# sigma_values = [1, 2]  # Test different Gaussian filter sizes
# low_thresholds = [0.1, 0.2, 0.3]  # Test lower thresholds
# high_thresholds = [0.2, 0.3, 0.4]  # Test higher thresholds
#
# # Path to your image
# image_path = "./imgs/overheadGolf1.jpg"  # Replace with your image path
#
# # Path to save the output image (output_path)
# output_path = (
#     image_path + "output.jpg"
# )  # Change the name and format as needed (e.g., .jpg, .png)
#
# # Run the program
